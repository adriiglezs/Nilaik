...
import { puma } from "../Carousel/data.js";
import cart from '../../assets/cart.svg';

export default function CardProductPuma() {
  return (<>
    <h1 className={style.cardProductencabezado}>Puma</h1>
    {puma.map(item => (
      <div key={item.id} className={style.cardProducttarget}>
        <div className={style.cardProductbackgroundPuma}>
