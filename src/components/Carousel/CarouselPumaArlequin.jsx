...
export default function CarouselPumaArlequin() {
  const [pumaArlequinItems, setpumaArlequinItems] = useState([]);

  useEffect(() => {
    const filteredData = pumaArlequin.filter(item => item.marca === "Puma arlequin");
    setpumaArlequinItems(filteredData);
  }, []);
